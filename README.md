# <span style="color:green"><p align="justify"> Это тестовый репозиторий, выполненный в рамках учебного курса Вадима Ксендзова по тестированию программного обеспечения. Здесь мои  первые шаги по изучению Git и GitHub. Ниже, собственно, одна из "домашек" и мой вариант ее решения. С целью закрепления изученного материала и практических навыков, инструментарием служили: Visual Studio Code; Git Bash; Markdown.</p></span>

## <span style="color:yellow">__1. Создать внешний репозиторий c названием json:__<span style="color:yellow">

 [Ссылка на репозиторий](https://github.com/gadaborshev/gr29_github_json.git)

## <span style="color:yellow">__2. Клонировать репозиторий json на локальный компьютер:__
...
![Скриншот_1](https://github.com/gadaborshev/gr29_github_json/blob/main/screenshot_1.jpg)
...
![Скриншот_2](https://github.com/gadaborshev/gr29_github_json/blob/main/screenshot_2.jpg)
